import { AnyFunction, objectKeys } from '@wallace-ui/utils';

/**
 * ### CSS 의사 클래스 리턴 함수 모음
 * @see [Mozila Docs](https://developer.mozilla.org/ko/docs/Web/CSS/Pseudo-classes)
 */
const group = {
  ...
  active: (selector: string) => `${selector}:active &, ${selector}[data-active] &`,
